...
<Steps>
  ...
  <Step title="Pick your first model">
    The Model Center opens. For a first chat, pick **Llama 3.1 8B Instruct** (good fit for 8 GB+). Click **Download** — progress shows in the bar.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Pick a model">
    For 8 GB GPUs, **Sana Sprint** is a good first choice — fast and high quality. For 12 GB+, try **FLUX Schnell**.
  </Step>
  <Step title="Generate">
...
<Steps>
  ...
  <Step title="Set boundaries">
    Choose hours when the module is active (e.g., when you're sleeping) and a GPU usage cap. Defaults are sensible — adjust later.
  </Step>
  <Step title="Watch GUSD accrue">
    Workloads will start dispatching to your GPU as the queue allows. The dashboard shows live earnings per hour.
  </Step>
</Steps>
