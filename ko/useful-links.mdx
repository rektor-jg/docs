...
<CardGroup cols={2}>
  ...
  <Card title="deAPI" icon="code" href="https://deapi.ai">
    GamerHash GPU 네트워크의 OpenAI 호환 API.
  </Card>
</CardGroup>
...
- [GHX 문서](https://docs.gamercoin.com) — 전체 토크노믹스, 컨트랙트, 스테이킹, 브리징
- [스테이킹 & 유동성 마이닝 대시보드](https://staking.gamercoin.com/) — 최대 **연 25% APR**
- [브리지 (cBridge)](https://cbridge.celer.network/) — 이더리움 ↔ BNB Chain 이체
...
- [X / Twitter](https://twitter.com/GamerHashCom) — 공지 및 짧은 형식 업데이트
- [Discord](https://gamerhash.com/en/l/Myw09) — 모더레이터의 가장 빠른 실시간 응답
- [Telegram](https://gamerhash.com/en/l/l9Nb9) — 더 폭넓은 공지 및 토론
- [YouTube](https://www.youtube.com/channel/UCv6axnIN6jczLcLraH4cK6g) — 제품 가이드 및 요약 영상
- [Medium](https://medium.com/we-are-the-gamerhash) — 장문 기사 및 월간 커뮤니티 업데이트
